...
if __name__ == "__main__":
    ...
    steps = {
        "suppressed": ["cos_diversity_cap_10000"],
        "unsuppressed": ["n_unique_words_total_cap_10000", "cos_diversity_cap_10000"],
    }
    ...
    for step, independent_variables in steps.items():
        ...
        estimator.fit(X, y)
        print(f"Optimal alpha: {estimator.alpha_}")
        ...
        plot_feature_interactions(
            ...
            save_path=f"viz_results/feature_interactions_v2/Ridge/suppression/interactions_{dep}_{step}_{cv_str}gen_n_{args.gen_n}.png",
        ...
        plot_coefficient_intervals(
            ...
            coefs=coefs[1:],
            p_values=p_values[1:],
            save_path=f"viz_results/feature_interactions_v2/Ridge/suppression/ridge_{'q' if 'quality' in dep else 'd'}_{step}_{args.gen_n}.pdf",
            no_show=args.no_show,
            legend=args.legend
        )
