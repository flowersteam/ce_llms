...
#
#python regression_analysis_plsr.py d -g 500 --no-show --cv 10 --no-feature-selection
#python regression_analysis_plsr.py d -g 1000 --no-show --cv 10 --no-feature-selection
#python regression_analysis_plsr.py q -g 500 --no-show --cv 10 --no-feature-selection
#python regression_analysis_plsr.py q -g 1000 --no-show --cv 10 --no-feature-selection