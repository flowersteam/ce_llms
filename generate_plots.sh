...
# dataset lens
#python visualize.py  --directories $dirs_pattern --metric len  --assert-n-datapoints 3 --no-show --save-path ${plots_dir}/dataset_lens
#
## diversity
...
#python visualize.py  --directories $dirs_pattern  --metric div -ip --assert-n-datapoints 3 --no-show --save-path ${plots_dir}/diversity_ip
#
## ce
...
#python visualize.py  --directories $dirs_pattern  --metric ce  -ip --assert-n-datapoints 3 --no-show --save-path ${plots_dir}/ce_ip
#
## tox
...
#python visualize.py  --directories $dirs_pattern  --metric tox -ip --assert-n-datapoints 3 --no-show --save-path ${plots_dir}/tox_ip
...
python visualize.py  --directories $dirs_pattern  --metric ttr -ip --assert-n-datapoints 3 --no-show --save-path ${plots_dir}/ttr_ip
