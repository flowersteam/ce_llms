...
class ClusterClassifier:
    ...
    def fit(self, texts,
            ...
            classifier_params={"n_neighbors": 10}, save_classifier_pickle_path=None, save_classifier_dir=None,  # classifier / cluster
            labels=None, cluster_summaries=None,
            ):
        # self.texts = texts
    ...
    def _show_mpl(self, df, title=None):
        ...
        if self.cluster_method == "gmm":
            self.make_ellipses(self.clustering, ax, lab_2_col)
...
if __name__ == "__main__":
    ...
    for eps, min_samples in cluster_params:
        for i, proj_par in enumerate(project_params_list):
            ...
            folder = folder + "proj_on_all_data/"

            _, projections, cluster_labels = cc.fit(
                texts,
                load_embeddings_folder=full_dataset_folder, save_embeddings_folder=folder,
                # load_embeddings_folder=folder, save_embeddings_folder=folder,
